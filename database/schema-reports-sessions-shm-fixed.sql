...
-- ============================================
-- FUNCTION: Update Timestamp for Reports
-- ============================================
...
-- ============================================
-- VIEW: Reports with Statistics (FIXED)
-- ============================================
DROP VIEW IF EXISTS reports_with_stats;

CREATE VIEW reports_with_stats AS
SELECT
  r.id,
  r.title,
  r.location,
...
-- ============================================
-- VIEW: Sessions Overview (FIXED)
-- ============================================
DROP VIEW IF EXISTS sessions_overview;
